...
fun Terms_Conditions_Card() {
    ...
    Card(
        ...
        Row(
            ...
            Icon(
                painter = painterResource(id = R.drawable.baseline_terms_and_conditions),
        ...
        Column(
            ...
            Text(
                modifier = Modifier
                    .padding(5.dp , 5.dp),
                text = "Our idea of fair usage and appliances towards our platform.",
                fontFamily = Poppins,
...
@Composable
fun Terms_Conditions_Card_Preview() {
